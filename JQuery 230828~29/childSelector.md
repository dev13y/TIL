    ...
    <head>
		...
		<script type="text/javascript">
            $(document).ready(function() {
                ...
                // 2. <ol> 태그의 자식 <li> 글자색 blue
                $('ol > li').css('color', 'blue');

                // 3. id가 children인 요소으ㅏ 자식 <li> 태그 밑줄
                $('#children > li').css('textDecoration', 'underline');

                // 4. class가 method인 요소의 모든 자손 요소의 글자색을 black
                $('.method').find('li').css('color', 'black');

                // 5. class가 method인 요소의 자식 요소에 속성 2개 설정
